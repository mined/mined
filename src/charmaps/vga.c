#include "charcode.h"
struct encoding_table_entry vga_table [] = {
	{0x00, 0x00, 0x0000, 0x0000},
	{0x00, 0x00, 0x0001, 0x263A},
	{0x00, 0x00, 0x0002, 0x263B},
	{0x00, 0x00, 0x0003, 0x2665},
	{0x00, 0x00, 0x0004, 0x2666},
	{0x00, 0x00, 0x0005, 0x2663},
	{0x00, 0x00, 0x0006, 0x2660},
	{0x00, 0x00, 0x0007, 0x2022},
	{0x00, 0x00, 0x0008, 0x25D8},
	{0x00, 0x00, 0x0009, 0x25CB},
	{0x00, 0x00, 0x000A, 0x25D9},
	{0x00, 0x00, 0x000B, 0x2642},
	{0x00, 0x00, 0x000C, 0x2640},
	{0x00, 0x00, 0x000D, 0x266A},
	{0x00, 0x00, 0x000E, 0x266B},
	{0x00, 0x00, 0x000F, 0x263C},
	{0x00, 0x00, 0x0010, 0x25BA},
	{0x00, 0x00, 0x0011, 0x25C4},
	{0x00, 0x00, 0x0012, 0x2195},
	{0x00, 0x00, 0x0013, 0x203C},
	{0x00, 0x00, 0x0014, 0x00B6},
	{0x00, 0x00, 0x0015, 0x00A7},
	{0x00, 0x00, 0x0016, 0x25AC},
	{0x00, 0x00, 0x0017, 0x21A8},
	{0x00, 0x00, 0x0018, 0x2191},
	{0x00, 0x00, 0x0019, 0x2193},
	{0x00, 0x00, 0x001A, 0x2192},
	{0x00, 0x00, 0x001B, 0x2190},
	{0x00, 0x00, 0x001C, 0x221F},
	{0x00, 0x00, 0x001D, 0x2194},
	{0x00, 0x00, 0x001E, 0x25B2},
	{0x00, 0x00, 0x001F, 0x25BC},
...
unsigned int vga_table_len = arrlen (vga_table);
