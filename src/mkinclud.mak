...
$(OBJDIR)/charmaps.a:	$(CHARDEPS)
	# ar has no option s on Ultrix, there is no ranlib on some systems
	ar ruvs $(OBJDIR)/charmaps.a $(CHAROBJS) || ar ruv $(OBJDIR)/charmaps.a $(CHAROBJS) && ranlib $(OBJDIR)/charmaps.a
...
rootmenudir=$(DESTDIR)$(prefix)/share/applications
rooticondir=$(DESTDIR)$(prefix)/share/pixmaps
localmenudir=$(DESTDIR)$(prefix)/local/share/applications
localicondir=$(DESTDIR)$(prefix)/local/share/pixmaps
